...
class JiraTriagerAgent:
    ...
    def _get_assignee_team_info(self, assignee: str) -> str:
        TEAM_ASSIGNEE_MAP = {
            "RHIDP - Cope": [
                "Paul Schultz", "Nick Boldt", "Bethany Griggs", "Kashish Mittal", "Joseph Kim", "Omar Al Jaljuli"
            ],
            "RHIDP - Documentation": [
                "Gerry Forde", "Heena Manwani", "Fabrice Flore-Thébault", "Kavya Verma", "Shipra Singh", "Judith Magak", "Priyanka Abel"
            ],
            "RHIDP - Dynamic Plugins": [
                "Stan Lewis", "Tomas Kral", "David Festal", "Rostislav Lan"
            ],
            "RHIDP - Frontend Plugins & UI": [
                "Jaivardhan Kumar", "Christoph Jerolimov", "Divyanshi Gupta", "Yi Cai", "Debsmita Santra", "Mitesh Kumar", "Sanket Saikia", "Jackson Lee"
            ],
            "RHIDP - Install": [
                "Fortune Ndlovu", "Armel Soro", "Gennady Azarenkov", "Subhash Khileri", "Zbynek Drapela"
            ],
            "RHIDP - Plugins": [
                "Patrick Knight", "Dominika Zemanovicova", "Oleksandr Andriienko", "Gustavo Lira e Silva", "Luke Holmquist", "Diana Janickova"
            ],
            "RHIDP - Security": [
                "Kim Tsao", "Jessica He", "Alessandro Barbarossa"
            ],
            "RHIDP - UXD": ["Shiran Hirshberg"],
            "RHDHPAI - DevAI": [
                "Elson Yuen", "Stephanie Cao", "John Collier", "Jordan Dubrick", "Maysun Faisal", "Theofanis Petkos", "Michael Valdron"
            ],
            "RHDHPAI - UI": [
                "Rohit Rai", "Karthik Jeeyar", "Eswaraiah Sapram", "Avik Kundu", "Jan Richter"
            ],
        }
        if not assignee:
            return ""
